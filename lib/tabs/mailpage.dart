...
import 'package:gmail_clone/models/message_model.dart';
import 'package:gmail_clone/models/user_model.dart';
import 'package:gmail_clone/tabs/mails.dart';
import 'package:gmail_clone/tabs/reply.dart';
        ...
        actions: [
          ...
          IconButton(
              ...
              onPressed: () {
                ...
                Navigator.push(
                    context, MaterialPageRoute(builder: (builder) => Mails()));
              }),
          IconButton(
